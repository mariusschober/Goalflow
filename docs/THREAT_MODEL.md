...
| Hostile backup / wrong password / tampering | Browser backups use PBKDF2-SHA256 plus AES-256-GCM; schema/checksum validation and atomic IndexedDB import; server backups use AES-256-GCM with a separately managed 32-byte key. |
