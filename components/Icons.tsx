...
export const BrainCircuit: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    ...
    >
      ...
      <path d="M19 12a7 7 0 1 0-13.996 0" />
      <path d="M5 12a7 7 0 1 0 13.996 0" />
...
export const AxeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const HorizonIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M2 12h20" />
...
export const SkullIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M12 2c-3.866 0-7 3.134-7 7 0 2.213 1.037 4.184 2.66 5.486L7 22h10l-.66-7.514A6.98 6.98 0 0 0 19 9c0-3.866-3.134-7-7-7Z" />
        <path d="M15 10a2 2 0 1 1-4 0" />
        <path d="M9 10a2 2 0 1 1-4 0" opacity="0" /> 
